<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Validação básica
        if(!empty($produto) && !empty($peso) && !empty($unidade) && !empty($preco) && !empty($fornecedor)) {
            $data = date('Y-m-d');
            ...
            $sql = "INSERT INTO cadastro_produto (fk_fornecedor, nome_produto, peso_produto, unidade_medida, data_cadastro, preco_unitario, data_validade, nota_fiscal) 
                    VALUES ('$fornecedor', '$produto', '$peso', '$unidade', '$data', '$preco', '$validade', '$nota')";
                ...
                <div class="form-container">
                    <form method="post" class="pergunta">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="unidade" required placeholder="Ex: Saco, Lata, Unidade" id="unidade-input" class="form-control">
                        </div>
